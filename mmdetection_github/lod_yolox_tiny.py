#!/usr/bin/env python3
# -*- coding:utf-8 -*-
"""LOAD-style YOLOX experiment for training on LOD in COCO format."""
...
class Exp(YoloXBaseExp):
    ...
    def get_data_loader(self, batch_size, is_distributed, no_aug=True, cache_img=False):
        from yolox.data import COCORawDataset, DataLoader, InfiniteSampler, MosaicDetectionRaw, TrainTransformRaw, YoloBatchSampler, worker_init_reset_seed
