...
#
# 5) 训练命令示例
#    python main.py -f cfg_lod_small.py -b 64 -c pre-trained/yolox_tiny.pth
#
# 6) 与 mmdet 其它项
...
class Exp(YoloXBaseExp):
    def __init__(self):
        ...
        self.width = 0.375
        self.act = 'silu'
        # 与 R_Net_taisp.py 中 TA_ResNet backbone 的 weight_range [2.0, 4.0] 对应
