...
#
# =============================================================================
# LOD + YOLOX-Tiny（depth=0.33, width=0.375）
# =============================================================================
#
# 数据与增强与 cfg_lod_small.py 相同；仅 backbone/head 宽度不同。预训练请使用 yolox_tiny.pth。
#
# 训练示例：
#   python main.py -f cfg/cfg_lod_tiny.py -b 64 -c pre-trained/yolox_tiny.pth
#
# 更完整的 LOD 说明见 cfg_lod_tiny.py 文件头注释。
#
# =============================================================================
...
# #    self.freeze_pretrained_yolox = True
