...
class Exp(YoloXBaseExp):
    def __init__(self):
        ...
        self.data_dir = '/data/chenkai/cvpr26/RAOD'
        # self.train_ann = 'train_night640.json'
        self.train_ann = 'train_day640.json'
        # self.val_ann = 'valid_night640.json'
        self.val_ann = 'valid_day640.json'
        # self.train_ims = self.val_ims = 'night_raws_debayer_fp32_640x640/Night'
        self.train_ims = self.val_ims = 'day_raws_debayer_fp32_640x640/Day'
        # ---------------- transform config ---------------- #
        ...
        self.momentum = 0.9
        self.print_interval = 20    # iter
        self.eval_interval = 5     # epoch
    ...
    def get_data_loader(self, batch_size, is_distributed, no_aug=True, cache_img=False):
        from yolox.data import COCORawDataset, TrainTransformRaw, YoloBatchSampler, COCOOriginDataset
        ...
        with wait_for_the_master(local_rank):
            # dataset = COCOOriginDataset(data_dir=self.data_dir, json_file=self.train_ann, name=self.train_ims, img_size=self.input_size,
    ...
    def get_eval_loader(self, batch_size, is_distributed, testdev=False, legacy=False):
        from yolox.data import COCORawDataset, ValTransformRaw, COCOOriginDataset
        # valdataset = COCOOriginDataset(data_dir=self.data_dir, json_file=self.val_ann if not testdev else self.test_ann,
